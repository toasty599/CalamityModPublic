...
namespace CalamityMod.Effects
{
    ...
    public class CalamityShaders
    {
        ...
        //
        // All below shaders created by Amber
        //
        ...
        internal static Effect DustDevilShader;
        #endregion
        ...
        public static void LoadShaders()
        {
            ...
            DustDevilShader = LoadShader("DustDevilShader");
            RegisterScreenShader(DustDevilShader, "DustDevilPass", "DustDevilShader");
            #endregion
        }
    }
}
